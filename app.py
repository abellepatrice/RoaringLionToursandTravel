...
def send_email(first_name, last_name, email_address, form_data):
    ...
    password = "GCE#)^KIXEuV"  # Update with your email password

    sender_email = "sender@roaringliontours.co.ke"
    receiver_email = "requests@roaringliontours.co.ke"  # Update with the recipient's email address
...
def contactus():
    if request.method == 'GET':
        ...
        connection = pymysql.connect(
            host='localhost',
            user='roaringl_developer',
            password='kACqkxfJvSBG',
            database='roaringl_requestquote',
        )
        ...
        # send_email(first_name,last_name,country,phone_number,email_address,duration_of_tour,start_date,no_of_adults,no_of_children,age_of_children,estimated_budget,currency,type_of_safari,tour_description,how_to_contact_you)
...
def requestquote():
  if request.method == 'GET':
        ...
        # duration_of_tour = request.form.get('duration_of_tour')
        # start_date = request.form.get('start_date')
        # no_of_adults = request.form.get('no_of_adults')
        # no_of_children = request.form.get('no_of_children')
        # age_of_children = request.form.get('age_of_children')
        # estimated_budget = request.form.get('estimated_budget')
        # currency = request.form.get('currency')
        # type_of_safari = request.form.get('type_of_safari')
        # tour_description = request.form.get('tour_description')
        # how_to_contact_you = request.form.get('how_to_contact_you')

        # try:
        #     # Connect to the database
        #     connection = pymysql.connect(host='localhost', user='roaringl_developer', password='kACqkxfJvSBG', database='roaringl_requestquote')
        #     cursor = connection.cursor()
